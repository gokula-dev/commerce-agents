...
const ASSISTANT = "Logitech Assistant";
...
function Wordmark() {
  return (
    <span className="flex items-center gap-2.5 pr-1">
      ...
      <span className="text-[17px] font-bold tracking-[-0.02em] text-(--ink)">Logitech</span>
    </span>
  );
}
...
export default function StorefrontPage() {
  ...
  return (
    <StoreShell
      ...
      placeholder="Ask about a product or a project…"
    >
