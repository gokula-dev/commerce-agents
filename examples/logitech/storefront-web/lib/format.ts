...
const KEYWORD_GLYPHS: [string, string][] = [
  ["mouse", "🖱️"], ["trackball", "🖱️"], ["mice", "🖱️"],
  ["keyboard", "⌨️"], ["keys", "⌨️"],
  ["webcam", "📷"], ["camera", "📷"],
  ["headset", "🎧"], ["headphone", "🎧"], ["earbud", "🎧"],
  ["speaker", "🔊"], ["microphone", "🎙️"], ["mic", "🎙️"],
  ["controller", "🎮"], ["joystick", "🕹️"], ["gamepad", "🎮"], ["racing wheel", "🏎️"],
  ["stylus", "🖊️"], ["pen", "🖊️"],
  ["stand", "💻"], ["dock", "🔌"], ["hub", "🔌"], ["cable", "🔌"], ["adapter", "🔌"],
  ["charging", "🔋"], ["battery", "🔋"],
  ["remote", "📺"], ["clicker", "📺"],
  ["light", "💡"], ["lamp", "💡"],
  ["backpack", "🎒"], ["case", "🎒"], ["sleeve", "🎒"],
];
